...
func (p *ProductUseCaseIml) GetAllProduct(ctx context.Context, req *productentity.GetProductsReq) (products *productentity.GetProductsRes, err error) {
...
func (p *ProductUseCaseIml) GetAllCategory(ctx context.Context) (categories *productentity.GetcategoriesRes, err error) {
